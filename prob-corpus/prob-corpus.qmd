...
model.  There is a rich literature after these two papers and there is
a parallel literature in the epidemiology literature on assessing
diagnostic tests without a gold standard dating back at least to the
1990s.  The maximum likelihood approach the authors employ can be
easily extended to a Bayesian hierarchical model (for example, by
@paun2018).
