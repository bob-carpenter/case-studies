...
$$
\sum_{y' \textrm{ a permuation of } y} p_Y(y' \mid \beta, \textrm{set}(y)) = 1.
$$

## Extended ranking models

The model can also be extended quite easily to observations such as
top-10 lists drawn from among a larger set of items.  
For example,
...
The ranking sare themselves an array of integers of size $R \times K$,
